...
- **[US-110]** Менеджерам начисляются бонусы за созданное задание и правильное выполнение задания потенциальным учителем. Количество бонусов зависит от рейтинга задания.  
  ...
  - **[US-112]** После обновления задания, бонусы зачисляются только тому, кто обновил задание, а не тому, кто его создал.  
...
![communications](homework-communications.jpg)

В схеме девять связей:  
